...
public class TestRVpActivity extends AppCompatActivity {
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        adapter = new CommonRecyclerAdapter<Integer>(this, list, R.layout.recycler_item) {
            @Override
            public void convert(ViewHolder holder, Integer item, int position) {
                SmartTabLayout smartTabLayout = holder.getView(R.id.tab_layout);
