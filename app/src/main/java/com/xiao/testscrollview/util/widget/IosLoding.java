...
public class IosLoding extends View {

    private static final String TAG = IosLoding.class.getSimpleName();
    /**
     * view宽度
     */
    private int width;
    ...
    public IosLoding(Context context) {
        this(context, null);
    }

    public IosLoding(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IosLoding(Context context, AttributeSet attrs, int defStyleAttr) {
